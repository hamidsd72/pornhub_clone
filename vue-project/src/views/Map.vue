<template>
    <div class="Register" :style="cssProps" style="background-position: center;background-repeat: no-repeat;background-size: cover;background-blend-mode: luminosity;">
        <div class="mx-auto" style="max-width:1360px;">
            <div class="row text-center">
                <div id="timeline">
                    <div class="row timeline-movement timeline-movement-top">
                        <div class="timeline-badge timeline-future-movement"><p>M 12 2018</p></div>
                    </div>
                    <div class="row timeline-movement">
                        <div class="timeline-badge center-left"></div>
                        <div class="col-sm-6 timeline-item pt-4 pt-lg-0">
                            <div class="row">
                                <div class="col-sm-11">
                                    <div class="timeline-panel credits anim animate fadeInLeft">
                                        <ul class="timeline-panel-ul">
                                            <div class="lefting-wrap"><li class="img-wraping"><a href="#"><img :src="require(`@/assets/images/logo.png`)" class="img-responsive" alt="user-image" /></a></li></div>
                                            <div class="righting-wrap text-left">
                                                <li><a href="#" class="importo">Continual Development</a></li>
                                                <li class="pl-2"><span class="causale">Website Redesign White Paper & Roadmap Marketing Campaig Mint NFTs Shop pornhub  5000 holder</span></li>
                                            </div>
                                            <div class="clear"></div>
                                        </ul>
                                    </div>
                    ...
                    <div class="row timeline-movement timeline-movement-top">
                        <div class="timeline-badge timeline-future-movement"><p>M 2 2022</p></div>
                    </div>
                    <div class="row timeline-movement">
                        <div class="timeline-badge center-right">
                        </div>
                        <div class="offset-sm-6 col-sm-6 timeline-item pt-4 pt-lg-0">
                            <div class="row">
                                    ...
                                    <div class="timeline-panel debits  anim animate  fadeInRight">
                                        <ul class="timeline-panel-ul">
                                            ...
                                            <div class="righting-wrap">
                                                <li><a href="#" class="importo">CEX & Coingecko & CMC Listing</a></li>
                                                <li class="pl-2"><span class="causale">Audit by CertiK 30,000 Holders Stake and farmers</span></li>
                    ...
                    <div class="row timeline-movement timeline-movement-top">
                        <div class="timeline-badge timeline-future-movement"><p>M 6 2022</p></div>
                    </div>
                    <div class="row timeline-movement">
                        <div class="timeline-badge center-left"></div>
                        <div class="col-sm-6 timeline-item pt-4 pt-lg-0">
                                ...
                                <div class="col-sm-11">
                                    <div class="timeline-panel credits anim animate fadeInLeft">
                                        <ul class="timeline-panel-ul">
                                            <div class="lefting-wrap"><li class="img-wraping"><a href="#"><img :src="require(`@/assets/images/logo.png`)" class="img-responsive" alt="user-image" /></a></li></div>
                                            <div class="righting-wrap text-left">
                                                <li><a href="#" class="importo">Update wait payper</a></li>
                                                <li class="pl-2"><span class="causale">Ecorit servi girls World Collaboration with Public Figures Pornhub nft 3d Sponsor events</span></li>
                                            </div>
                                            <div class="clear"></div>
                                        </ul>
                                    </div>
                    ...
                    <div class="row timeline-movement timeline-movement-top">
                        <div class="timeline-badge timeline-future-movement"><p>M 9 2022</p></div>
                    </div>
                    <div class="row timeline-movement">
                        <div class="timeline-badge center-right">
                        </div>
                                ...
                                <div class="offset-sm-1 col-sm-11">
                                    <div class="timeline-panel debits  anim animate  fadeInRight">
                                        <ul class="timeline-panel-ul">
                                            <div class="lefting-wrap"><li class="img-wraping"><a href="#"><img :src="require(`@/assets/images/logo.png`)" class="img-responsive" alt="user-image" /></a></li></div>
                                            <div class="righting-wrap">
                                                <li><a href="#" class="importo">NFTs Marketplace</a></li>
                                                <li class="pl-2"><span class="causale">Demo Gamefi pornhub +18 Shop Avatar Play to Land Website 2 mobile app V2</span></li>
                                                <!-- <li><p><small class="text-muted"><i class="glyphicon glyphicon-time"></i> 12/01/2018, 13:05"</small></p> </li> -->
                                            </div>
                                            <div class="clear"></div>
                                        </ul>
                    ...
                    <div class="row timeline-movement timeline-movement-top">
                        <div class="timeline-badge timeline-future-movement"><p>M 12 2023</p></div>
                    </div>
                    <div class="row timeline-movement">
                        <div class="timeline-badge center-left"></div>
                        <div class="col-sm-6 timeline-item pt-4 pt-lg-0">
                                ...
                                <div class="col-sm-11">
                                    <div class="timeline-panel credits anim animate fadeInLeft">
                                        <ul class="timeline-panel-ul">
                                            <div class="lefting-wrap"><li class="img-wraping"><a href="#"><img :src="require(`@/assets/images/logo.png`)" class="img-responsive" alt="user-image" /></a></li></div>
                                            <div class="righting-wrap text-left">
                                                <li><a href="#" class="importo">Club vr 3d</a></li>
                                                <li class="pl-2"><span class="causale">Living room Dico xr Web4 World pornhub Artist / influencer partnerships</span></li>
                                            </div>
                                            <div class="clear"></div>
                                        </ul>
                                    </div>
...
export default {
    data() {
        return {
            // cssProps: { backgroundImage: `url(${require('@/assets/images/sea.jpg')}) , url(${require('@/assets/images/reg.jpg')}) ` },
            // cssProps: { backgroundImage: `url(${require('@/assets/images/sea.jpg')}) ` },
            cssProps: { backgroundImage: `url(${require('@/assets/images/v4.jpg')}) ` },
        }
    },
    mounted() {
        ...
        $(document).ready(function(){
            $(" .debits").hover(function(){
                $(" .center-right").css("background-color", "#ff9900");
                }, function(){
        ...
        $(document).ready(function(){
            $(".credits").hover(function(){
                $(".center-left").css("background-color", "#ff9900");
                }, function(){
